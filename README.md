...
## Lessons Learned
- Simple Python scripts can solve real-world cloud management problems quickly.
- Input validation (department allowlist, case normalization) is just as important as core functionality.
- Small formatting choices (removing dashes, enforcing uppercase) improve clarity and standardization.
